        ...
        return (
          <FormItem className={cn('relative', classContent)}>
            <Select onValueChange={field.onChange} defaultValue={field.value}>
              <FormControl>
                <SelectTrigger className={'peer'}><SelectValue placeholder={trigger} /></SelectTrigger>
              </FormControl>
              <SelectContent>
                {
            ...
            <FormLabel
              className={cn('absolute font-normal bg-white blur-10 w-fit px-2 -top-5 py-1 rounded left-3 peer-focus:font-semibold',
